...
interface Input {
  ...
  companion object {
    @JvmStatic @JvmName("of") fun Path.asInput() = PathInput(this)

    @JvmStatic @JvmName("of") fun ByteString.asInput(name: String) = BytesInput(name, this)

    @JvmStatic @JvmName("of") fun String.asInput(name: String) = StringInput(name, this)
  }
}

class PathInput internal constructor(val path: Path) : Input {
  override val name
...
class BytesInput internal constructor(override val name: String, val bytes: ByteString) : Input {
...
class StringInput internal constructor(override val name: String, private val string: String) :
  Input {
