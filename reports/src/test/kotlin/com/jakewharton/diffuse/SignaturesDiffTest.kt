...
class SignaturesDiffTest {
  ...
  private val signatureV1Only =
    Signatures(listOf("v1v1".encodeUtf8()), emptyList(), emptyList(), emptyList())
  private val signatureV1AndV2 =
    Signatures(listOf("v1v1".encodeUtf8()), listOf("v2v2".encodeUtf8()), emptyList(), emptyList())
  private val signatureV1AndV3 =
    Signatures(listOf("v1v1".encodeUtf8()), emptyList(), listOf("v3v3".encodeUtf8()), emptyList())
  private val signatureV3AndV4 =
    Signatures(emptyList(), emptyList(), listOf("v3v3".encodeUtf8()), listOf("v4v4".encodeUtf8()))
