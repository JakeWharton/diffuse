...
class DexParserTest {
  @Test fun types() {
    ...
    assertThat(dexParser.declaredMembers().map(DexMember::toString)).containsExactly(
        "Types <init>()",
        "Types returnsBoolean() → boolean",
        "Types returnsRunnable() → Runnable",
        "Types returnsString() → String",
    ...
    assertThat(dexParser.referencedMembers().map(DexMember::toString)).containsExactly(
        "java.io.PrintStream println(String)",
        "java.lang.Object <init>()",
        "java.lang.System out: PrintStream"
    ).inOrder()
    ...
    assertThat(dexParser.declaredMethods().map(DexMethod::toString)).containsExactly(
        "Types <init>()",
        "Types returnsBoolean() → boolean",
        "Types returnsRunnable() → Runnable",
        "Types returnsString() → String",
    ...
    assertThat(dexParser.referencedMethods().map(DexMethod::toString)).containsExactly(
        "java.io.PrintStream println(String)",
        "java.lang.Object <init>()"
    ).inOrder()
    ...
    assertThat(dexParser.declaredFields().map(DexField::toString)).containsExactly(
        "Types valueBoolean: boolean",
        "Types valueByte: byte",
        "Types valueChar: char",
        "Types valueDouble: double",
    ...
    assertThat(dexParser.referencedFields().map(DexField::toString)).containsExactly(
        "java.lang.System out: PrintStream"
    ).inOrder()
  }
