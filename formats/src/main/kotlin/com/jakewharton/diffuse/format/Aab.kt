...
private constructor(
  ...
  val modules
    get() = listOf(baseModule, *featureModules.values.toTypedArray())
  ...
  private constructor(
    ...
    companion object {
      ...
      fun Zip.toModule(): Module {
        ...
        val manifest =
          this[MANIFEST_FILE_PATH].asInput().source().use {
  ...
  companion object {
    ...
    fun Input.toAab(): Aab {
      toZip().use { zip ->
        val apiMapping =
          zip.find(METADATA_OBFUSCATION_DIRECTORY_NAME)?.asInput()?.toApiMapping()
            ?: ApiMapping.EMPTY
        ...
        val featureModules =
          zip.directories
            ...
            .filter {
              it != BASE_DIRECTORY_NAME && it != BUNDLE_METADATA_DIRECTORY_NAME && it != "META-INF"
            }
